...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision "docker" do |docker|
    ...
    docker.run "consul"     , image: "consul:latest"                         , args: "-p 8300:8300 -p 8301:8301 -p 8302:8302 -p 8500:8500 -p 53:8600 -p 8301:8301/udp -p 8302:8302/udp -p 53:8600/udp -v /var/docker/consul/config:/consul/config -v /var/docker/consul/data:/consul/data -e SERVICE_8300_NAME=consul-rpc -e SERVICE_8301_NAME=consul-serf-lan -e SERVICE_8302_NAME=consul-serf-wan -e SERVICE_8500_NAME=consul-interface -e SERVICE_8600_NAME=consul-dns"
